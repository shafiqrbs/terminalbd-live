 ...
 * HmsPurchaseItem
 *
 * @ORM\Table(name ="hms_purchase_item")
 * @ORM\Entity(repositoryClass="Appstore\Bundle\HospitalBundle\Repository\HmsPurchaseItemRepository")
 */
class HmsPurchaseItem
{
    /**
     * @var integer
     *
    ...
    /**
     * @ORM\ManyToOne(targetEntity="Appstore\Bundle\HospitalBundle\Entity\Particular", inversedBy="purchaseItems" )
     **/
    private  $particular;


    /**
     * @ORM\ManyToOne(targetEntity="Appstore\Bundle\HospitalBundle\Entity\HmsPurchase", inversedBy="purchaseItems" )
